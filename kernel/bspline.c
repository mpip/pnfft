    ...
    )
{
    ...
    case 4: switch(i) {
      case 0 : return (1 + 2*x)/2.;
      case 1 : return (-1 - 6*x)/2.;
      case 2 : return (-1 + 6*x)/2.;
      case 3 : return (1 - 2*x)/2.;
      default: return 0.0;
    }
    case 5: switch(i) {
      case 0 : return (1 + x*(4 + 4*x))/8.;
      case 1 : return (1 + (-2 - 4*x)*x)/2.;
      case 2 : return (-5 + 12*x*x)/4.;
      case 3 : return (1 + (2 - 4*x)*x)/2.;
      case 4 : return (1 + x*(-4 + 4*x))/8.;
      default: return 0.0;
    }
    case 6: switch(i) {
      case 0 : return (1 + x*(6 + x*(12 + 8*x)))/48.;
      case 1 : return (21 + x*(18 + (-36 - 40*x)*x))/48.;
      case 2 : return (-11 + x*(-42 + x*(12 + 40*x)))/24.;
      case 3 : return (-11 + x*(42 + (12 - 40*x)*x))/24.;
      case 4 : return (21 + x*(-18 + x*(-36 + 40*x)))/48.;
      case 5 : return (1 + x*(-6 + (12 - 8*x)*x))/48.;
      default: return 0.0;
    }
    case 7: switch(i) {
      case 0 : return (1 + x*(8 + x*(24 + x*(32 + 16*x))))/384.;
      case 1 : return (37 + x*(80 + x*(24 + (-64 - 48*x)*x)))/192.;
      case 2 : return (79 + x*(-344 + x*(-408 + x*(160 + 240*x))))/384.;
      case 3 : return (-77 + x*x*(168 - 80*x*x))/96.;
      case 4 : return (79 + x*(344 + x*(-408 + x*(-160 + 240*x))))/384.;
      case 5 : return (37 + x*(-80 + x*(24 + (64 - 48*x)*x)))/192.;
      case 6 : return (1 + x*(-8 + x*(24 + x*(-32 + 16*x))))/384.;
      default: return 0.0;
    }
    case 8: switch(i) {
      case 0 : return (1 + x*(10 + x*(40 + x*(80 + x*(80 + 32*x)))))/3840.;
      case 1 : return (235 + x*(730 + x*(760 + x*(80 + (-400 - 224*x)*x))))/3840.;
      case 2 : return (1209 + x*(50 + x*(-2520 + x*(-1520 + x*(720 + 672*x)))))/3840.;
      case 3 : return (-289 + x*(-774 + x*(344 + x*(720 + (-80 - 224*x)*x))))/768.;
      case 4 : return (-289 + x*(774 + x*(344 + x*(-720 + x*(-80 + 224*x)))))/768.;
      case 5 : return (1209 + x*(-50 + x*(-2520 + x*(1520 + (720 - 672*x)*x))))/3840.;
      case 6 : return (235 + x*(-730 + x*(760 + x*(-80 + x*(-400 + 224*x)))))/3840.;
      case 7 : return (1 + x*(-10 + x*(40 + x*(-80 + (80 - 32*x)*x))))/3840.;
      default: return 0.0;
    }
    case 9: switch(i) {
      case 0 : return (1 + x*(12 + x*(60 + x*(160 + x*(240 + x*(192 + 64*x))))))/46080.;
      case 1 : return (90 + x*(351 + x*(540 + x*(360 + (-144 - 64*x)*x*x))))/5760.;
      case 2 : return (2275 + x*(2922 + x*(-1020 + x*(-3280 + x*(-1200 + x*(672 + 448*x))))))/11520.;
      case 3 : return (398 + x*(-3981 + x*(-2940 + x*(2120 + x*(1920 + (-336 - 448*x)*x)))))/5760.;
      case 4 : return (-2601 + x*x*(4644 + x*x*(-2160 + 448*x*x)))/4608.;
      case 5 : return (398 + x*(3981 + x*(-2940 + x*(-2120 + x*(1920 + (336 - 448*x)*x)))))/5760.;
      case 6 : return (2275 + x*(-2922 + x*(-1020 + x*(3280 + x*(-1200 + x*(-672 + 448*x))))))/11520.;
      case 7 : return (90 + x*(-351 + x*(540 + x*(-360 + (144 - 64*x)*x*x))))/5760.;
      case 8 : return (1 + x*(-12 + x*(60 + x*(-160 + x*(240 + x*(-192 + 64*x))))))/46080.;
      default: return 0.0;
    }
    case 10: switch(i) {
      case 0 : return (1 + x*(14 + x*(84 + x*(280 + x*(560 + x*(672 + x*(448 + 128*x)))))))/645120.;
      case 1 : return (2177 + x*(10066 + x*(19572 + x*(19880 + x*(9520 + x*(-672 + (-3136 - 1152*x)*x))))))/645120.;
      case 2 : return (14075 + x*(29330 + x*(15540 + x*(-9800 + x*(-14000 + x*(-3360 + x*(2240 + 1152*x)))))))/161280.;
      case 3 : return (5021 + x*(-2958 + x*(-10884 + x*(-3240 + x*(3760 + x*(2016 + (-448 - 384*x)*x))))))/23040.;
      case 4 : return (-14219 + x*(-29194 + x*(15924 + x*(23320 + x*(-4240 + x*(-7392 + x*(448 + 1152*x)))))))/46080.;
      case 5 : return (-14219 + x*(29194 + x*(15924 + x*(-23320 + x*(-4240 + x*(7392 + (448 - 1152*x)*x))))))/46080.;
      case 6 : return (5021 + x*(2958 + x*(-10884 + x*(3240 + x*(3760 + x*(-2016 + x*(-448 + 384*x)))))))/23040.;
      case 7 : return (14075 + x*(-29330 + x*(15540 + x*(9800 + x*(-14000 + x*(3360 + (2240 - 1152*x)*x))))))/161280.;
      case 8 : return (2177 + x*(-10066 + x*(19572 + x*(-19880 + x*(9520 + x*(672 + x*(-3136 + 1152*x)))))))/645120.;
      case 9 : return (1 + x*(-14 + x*(84 + x*(-280 + x*(560 + x*(-672 + (448 - 128*x)*x))))))/645120.;
      default: return 0.0;
    }
    case 11: switch(i) {
      case 0 : return (1 + x*(16 + x*(112 + x*(448 + x*(1120 + x*(1792 + x*(1792 + x*(1024 + 256*x))))))))/1.032192e7;
      case 1 : return (3275 + x*(17408 + x*(40208 + x*(51968 + x*(39200 + x*(14336 + x*(-1792 + (-4096 - 1280*x)*x)))))))/5.16096e6;
      case 2 : return (318509 + x*(865968 + x*(858032 + x*(227136 + x*(-236320 + x*(-209664 + x*(-34048 + x*(27648 + 11520*x))))))))/1.032192e7;
      case 3 : return (228577 + x*(168576 + x*(-200144 + x*(-244608 + x*(-25760 + x*(64512 + x*(23296 + (-6144 - 3840*x)*x)))))))/1.29024e6;
      case 4 : return (2575 + x*(-388176 + x*(-186224 + x*(201024 + x*(119200 + x*(-37632 + x*(-30464 + x*(3072 + 3840*x))))))))/737280.;
      case 5 : return (-156409 + x*x*(233552 + x*x*(-93280 + x*x*(19712 - 2304*x*x))))/368640.;
      case 6 : return (2575 + x*(388176 + x*(-186224 + x*(-201024 + x*(119200 + x*(37632 + x*(-30464 + x*(-3072 + 3840*x))))))))/737280.;
      case 7 : return (228577 + x*(-168576 + x*(-200144 + x*(244608 + x*(-25760 + x*(-64512 + x*(23296 + (6144 - 3840*x)*x)))))))/1.29024e6;
      case 8 : return (318509 + x*(-865968 + x*(858032 + x*(-227136 + x*(-236320 + x*(209664 + x*(-34048 + x*(-27648 + 11520*x))))))))/1.032192e7;
      case 9 : return (3275 + x*(-17408 + x*(40208 + x*(-51968 + x*(39200 + x*(-14336 + x*(-1792 + (4096 - 1280*x)*x)))))))/5.16096e6;
      case 10 : return (1 + x*(-16 + x*(112 + x*(-448 + x*(1120 + x*(-1792 + x*(1792 + x*(-1024 + 256*x))))))))/1.032192e7;
      default: return 0.0;
    }
    case 12: switch(i) {
      case 0 : return (1 + x*(18 + x*(144 + x*(672 + x*(2016 + x*(4032 + x*(5376 + x*(4608 + x*(2304 + 512*x)))))))))/1.8579456e8;
      case 1 : return (19671 + x*(117882 + x*(313200 + x*(481824 + x*(465696 + x*(278208 + x*(80640 + x*(-13824 + (-20736 - 5632*x)*x))))))))/1.8579456e8;
      case 2 : return (1716995 + x*(5615262 + x*(7480368 + x*(4665696 + x*(554400 + x*(-1132992 + x*(-715008 + x*(-78336 + x*(80640 + 28160*x)))))))))/1.8579456e8;
      case 3 : return (6071655 + x*(9060642 + x*(1447920 + x*(-4918368 + x*(-3276000 + x*(36288 + x*(725760 + x*(188928 + (-57600 - 28160*x)*x))))))))/6.193152e7;
      case 4 : return (4625615 + x*(-5377698 + x*(-10174608 + x*(-1005984 + x*(3578400 + x*(1124928 + x*(-521472 + x*(-262656 + x*(34560 + 28160*x)))))))))/3.096576e7;
      case 5 : return (-1135841 + x*(-1892358 + x*(1164528 + x*(1306656 + x*(-301536 + x*(-366912 + x*(37632 + x*(59904 + (-2304 - 5632*x)*x))))))))/4.42368e6;
      case 6 : return (-1135841 + x*(1892358 + x*(1164528 + x*(-1306656 + x*(-301536 + x*(366912 + x*(37632 + x*(-59904 + x*(-2304 + 5632*x)))))))))/4.42368e6;
      case 7 : return (4625615 + x*(5377698 + x*(-10174608 + x*(1005984 + x*(3578400 + x*(-1124928 + x*(-521472 + x*(262656 + (34560 - 28160*x)*x))))))))/3.096576e7;
      case 8 : return (6071655 + x*(-9060642 + x*(1447920 + x*(4918368 + x*(-3276000 + x*(-36288 + x*(725760 + x*(-188928 + x*(-57600 + 28160*x)))))))))/6.193152e7;
      case 9 : return (1716995 + x*(-5615262 + x*(7480368 + x*(-4665696 + x*(554400 + x*(1132992 + x*(-715008 + x*(78336 + (80640 - 28160*x)*x))))))))/1.8579456e8;
      case 10 : return (19671 + x*(-117882 + x*(313200 + x*(-481824 + x*(465696 + x*(-278208 + x*(80640 + x*(13824 + x*(-20736 + 5632*x)))))))))/1.8579456e8;
      case 11 : return (1 + x*(-18 + x*(144 + x*(-672 + x*(2016 + x*(-4032 + x*(5376 + x*(-4608 + (2304 - 512*x)*x))))))))/1.8579456e8;
      default: return 0.0;
    }
    case 13: switch(i) {
      case 0 : return (1 + x*(20 + x*(180 + x*(960 + x*(3360 + x*(8064 + x*(13440 + x*(15360 + x*(11520 + x*(5120 + 1024*x))))))))))/3.7158912e9;
      case 1 : return (14759 + x*(98350 + x*(294660 + x*(521760 + x*(601440 + x*(463680 + x*(228480 + x*(53760 + x*(-11520 + (-12800 - 3072*x)*x)))))))))/9.289728e8;
      case 2 : return (4499033 + x*(16973240 + x*(27486900 + x*(23890560 + x*(10459680 + x*(177408 + x*(-2352000 + x*(-1136640 + x*(-80640 + x*(112640 + 33792*x))))))))))/1.8579456e9;
      case 3 : return (8006383 + x*(16497970 + x*(10783332 + x*(-1045536 + x*(-4855200 + x*(-2076480 + x*(206976 + x*(413184 + x*(80640 + (-28160 - 11264*x)*x)))))))))/1.8579456e8;
      case 4 : return (37295841 + x*(12718300 + x*(-39632076 + x*(-29062848 + x*(2906400 + x*(8346240 + x*(1475712 + x*(-1010688 + x*(-357120 + x*(56320 + 33792*x))))))))))/2.4772608e8;
      case 5 : return (-4518883 + x*(-62882510 + x*(-19672020 + x*(30543840 + x*(12690720 + x*(-5689152 + x*(-3077760 + x*(560640 + x*(426240 + (-28160 - 33792*x)*x)))))))))/1.548288e8;
      case 6 : return (-14765933 + x*x*(18923580 + x*x*(-6533280 + x*x*(1223040 + x*x*(-149760 + 11264*x*x)))))/4.42368e7;
      case 7 : return (-4518883 + x*(62882510 + x*(-19672020 + x*(-30543840 + x*(12690720 + x*(5689152 + x*(-3077760 + x*(-560640 + x*(426240 + (28160 - 33792*x)*x)))))))))/1.548288e8;
      case 8 : return (37295841 + x*(-12718300 + x*(-39632076 + x*(29062848 + x*(2906400 + x*(-8346240 + x*(1475712 + x*(1010688 + x*(-357120 + x*(-56320 + 33792*x))))))))))/2.4772608e8;
      case 9 : return (8006383 + x*(-16497970 + x*(10783332 + x*(1045536 + x*(-4855200 + x*(2076480 + x*(206976 + x*(-413184 + x*(80640 + (28160 - 11264*x)*x)))))))))/1.8579456e8;
      case 10 : return (4499033 + x*(-16973240 + x*(27486900 + x*(-23890560 + x*(10459680 + x*(-177408 + x*(-2352000 + x*(1136640 + x*(-80640 + x*(-112640 + 33792*x))))))))))/1.8579456e9;
      case 11 : return (14759 + x*(-98350 + x*(294660 + x*(-521760 + x*(601440 + x*(-463680 + x*(228480 + x*(-53760 + x*(-11520 + (12800 - 3072*x)*x)))))))))/9.289728e8;
      case 12 : return (1 + x*(-20 + x*(180 + x*(-960 + x*(3360 + x*(-8064 + x*(13440 + x*(-15360 + x*(11520 + x*(-5120 + 1024*x))))))))))/3.7158912e9;
      default: return 0.0;
    }
    case 14: switch(i) {
      case 0 : return (1 + x*(22 + x*(220 + x*(1320 + x*(5280 + x*(14784 + x*(29568 + x*(42240 + x*(42240 + x*(28160 + x*(11264 + 2048*x)))))))))))/8.17496064e10;
      case 1 : return (177133 + x*(1298770 + x*(4327180 + x*(8642040 + x*(11473440 + x*(10570560 + x*(6771072 + x*(2830080 + x*(549120 + x*(-140800 + (-123904 - 26624*x)*x))))))))))/8.17496064e10;
      case 2 : return (23174079 + x*(98329330 + x*(184541940 + x*(197248920 + x*(125658720 + x*(40729920 + x*(-2749824 + x*(-8828160 + x*(-3421440 + x*(-140800 + x*(304128 + 79872*x)))))))))))/4.08748032e10;
      case 3 : return (59538773 + x*(151129594 + x*(148006460 + x*(53564280 + x*(-17172960 + x*(-23604672 + x*(-6980736 + x*(1263360 + x*(1317120 + x*(197120 + (-78848 - 26624*x)*x))))))))))/3.7158912e9;
      case 4 : return (146861165 + x*(159723982 + x*(-27836980 + x*(-108019704 + x*(-41503200 + x*(11256000 + x*(11114880 + x*(1028352 + x*(-1171200 + x*(-309760 + x*(56320 + 26624*x)))))))))))/1.48635648e9;
      case 5 : return (252044071 + x*(-445260538 + x*(-566651580 + x*(27189480 + x*(194832480 + x*(34797504 + x*(-29081472 + x*(-9143040 + x*(2384640 + x*(1154560 + (-101376 - 79872*x)*x))))))))))/2.4772608e9;
      case 6 : return (-134478763 + x*(-188647530 + x*(125765020 + x*(114539400 + x*(-30543840 + x*(-28445760 + x*(3792768 + x*(4204800 + x*(-280320 + x*(-422400 + x*(11264 + 26624*x)))))))))))/6.193152e8;
      case 7 : return (-134478763 + x*(188647530 + x*(125765020 + x*(-114539400 + x*(-30543840 + x*(28445760 + x*(3792768 + x*(-4204800 + x*(-280320 + x*(422400 + (11264 - 26624*x)*x))))))))))/6.193152e8;
      case 8 : return (252044071 + x*(445260538 + x*(-566651580 + x*(-27189480 + x*(194832480 + x*(-34797504 + x*(-29081472 + x*(9143040 + x*(2384640 + x*(-1154560 + x*(-101376 + 79872*x)))))))))))/2.4772608e9;
      case 9 : return (146861165 + x*(-159723982 + x*(-27836980 + x*(108019704 + x*(-41503200 + x*(-11256000 + x*(11114880 + x*(-1028352 + x*(-1171200 + x*(309760 + (56320 - 26624*x)*x))))))))))/1.48635648e9;
      case 10 : return (59538773 + x*(-151129594 + x*(148006460 + x*(-53564280 + x*(-17172960 + x*(23604672 + x*(-6980736 + x*(-1263360 + x*(1317120 + x*(-197120 + x*(-78848 + 26624*x)))))))))))/3.7158912e9;
      case 11 : return (23174079 + x*(-98329330 + x*(184541940 + x*(-197248920 + x*(125658720 + x*(-40729920 + x*(-2749824 + x*(8828160 + x*(-3421440 + x*(140800 + (304128 - 79872*x)*x))))))))))/4.08748032e10;
      case 12 : return (177133 + x*(-1298770 + x*(4327180 + x*(-8642040 + x*(11473440 + x*(-10570560 + x*(6771072 + x*(-2830080 + x*(549120 + x*(140800 + x*(-123904 + 26624*x)))))))))))/8.17496064e10;
      case 13 : return (1 + x*(-22 + x*(220 + x*(-1320 + x*(5280 + x*(-14784 + x*(29568 + x*(-42240 + x*(42240 + x*(-28160 + (11264 - 2048*x)*x))))))))))/8.17496064e10;
      default: return 0.0;
    }
    case 15: switch(i) {
      case 0 : return (1 + x*(24 + x*(264 + x*(1760 + x*(7920 + x*(25344 + x*(59136 + x*(101376 + x*(126720 + x*(112640 + x*(67584 + x*(24576 + 4096*x))))))))))))/1.9619905536e12;
      case 1 : return (265713 + x*(2125584 + x*(7792488 + x*(17307840 + x*(25922160 + x*(27523584 + x*(21111552 + x*(11556864 + x*(4181760 + x*(675840 + x*(-202752 + (-147456 - 28672*x)*x)))))))))))/9.809952768e11;
      case 2 : return (236169115 + x*(1108104600 + x*(2344318680 + x*(2918053600 + x*(2315134800 + x*(1151251200 + x*(283557120 + x*(-42071040 + x*(-61459200 + x*(-19712000 + x*(-337920 + x*(1597440 + 372736*x))))))))))))/1.9619905536e12;
      case 3 : return (2558744669 + x*(7581029088 + x*(9384577224 + x*(5774116480 + x*(1175874480 + x*(-754947072 + x*(-600762624 + x*(-126922752 + x*(34087680 + x*(23879680 + x*(2770944 + (-1277952 - 372736*x)*x)))))))))))/4.904976384e11;
      case 4 : return (9109380891 + x*(14765478696 + x*(5956328664 + x*(-3481582560 + x*(-3883362480 + x*(-831216384 + x*(413957376 + x*(238408704 + x*(7845120 + x*(-22640640 + x*(-4663296 + x*(958464 + 372736*x))))))))))))/1.783627776e11;
      case 5 : return (11134632509 + x*(261916656 + x*(-12806409144 + x*(-6243079360 + x*(1865000880 + x*(1900832256 + x*(96225024 + x*(-244832256 + x*(-48856320 + x*(17346560 + x*(6014976 + (-638976 - 372736*x)*x)))))))))))/8.91813888e10;
      case 6 : return (-2708146469 + x*(-18959018952 + x*(-3711954984 + x*(8557693280 + x*(2585808720 + x*(-1521637632 + x*(-594322176 + x*(151723008 + x*(77886720 + x*(-9349120 + x*(-6825984 + x*(319488 + 372736*x))))))))))))/5.94542592e10;
      case 7 : return (-2017181445 + x*x*(2263770360 + x*x*(-687236400 + x*x*(113783040 + x*x*(-12614400 + x*x*(1013760 - 53248*x*x))))))/7.4317824e9;
      case 8 : return (-2708146469 + x*(18959018952 + x*(-3711954984 + x*(-8557693280 + x*(2585808720 + x*(1521637632 + x*(-594322176 + x*(-151723008 + x*(77886720 + x*(9349120 + x*(-6825984 + x*(-319488 + 372736*x))))))))))))/5.94542592e10;
      case 9 : return (11134632509 + x*(-261916656 + x*(-12806409144 + x*(6243079360 + x*(1865000880 + x*(-1900832256 + x*(96225024 + x*(244832256 + x*(-48856320 + x*(-17346560 + x*(6014976 + (638976 - 372736*x)*x)))))))))))/8.91813888e10;
      case 10 : return (9109380891 + x*(-14765478696 + x*(5956328664 + x*(3481582560 + x*(-3883362480 + x*(831216384 + x*(413957376 + x*(-238408704 + x*(7845120 + x*(22640640 + x*(-4663296 + x*(-958464 + 372736*x))))))))))))/1.783627776e11;
      case 11 : return (2558744669 + x*(-7581029088 + x*(9384577224 + x*(-5774116480 + x*(1175874480 + x*(754947072 + x*(-600762624 + x*(126922752 + x*(34087680 + x*(-23879680 + x*(2770944 + (1277952 - 372736*x)*x)))))))))))/4.904976384e11;
      case 12 : return (236169115 + x*(-1108104600 + x*(2344318680 + x*(-2918053600 + x*(2315134800 + x*(-1151251200 + x*(283557120 + x*(42071040 + x*(-61459200 + x*(19712000 + x*(-337920 + x*(-1597440 + 372736*x))))))))))))/1.9619905536e12;
      case 13 : return (265713 + x*(-2125584 + x*(7792488 + x*(-17307840 + x*(25922160 + x*(-27523584 + x*(21111552 + x*(-11556864 + x*(4181760 + x*(-675840 + x*(-202752 + (147456 - 28672*x)*x)))))))))))/9.809952768e11;
      case 14 : return (1 + x*(-24 + x*(264 + x*(-1760 + x*(7920 + x*(-25344 + x*(59136 + x*(-101376 + x*(126720 + x*(-112640 + x*(67584 + x*(-24576 + 4096*x))))))))))))/1.9619905536e12;
      default: return 0.0;
    }
    case 16: switch(i) {
      case 0 : return (1 + x*(26 + x*(312 + x*(2288 + x*(11440 + x*(41184 + x*(109824 + x*(219648 + x*(329472 + x*(366080 + x*(292864 + x*(159744 + x*(53248 + 8192*x)))))))))))))/5.10117543936e13;
      case 1 : return (1594307 + x*(13817050 + x*(55264872 + x*(135067504 + x*(224990480 + x*(269549280 + x*(238427904 + x*(156609024 + x*(74790144 + x*(23795200 + x*(3221504 + x*(-1118208 + (-692224 - 122880*x)*x))))))))))))/5.10117543936e13;
      case 2 : return (1195194077 + x*(6126579914 + x*(14350094616 + x*(20182358768 + x*(18742346480 + x*(11769110496 + x*(4750217472 + x*(896383488 + x*(-211850496 + x*(-201710080 + x*(-54765568 + x*(159744 + x*(4100096 + 860160*x)))))))))))))/5.10117543936e13;
      case 3 : return (5965313739 + x*(19997619122 + x*(29216011752 + x*(23462660144 + x*(10089206160 + x*(955345248 + x*(-1390346496 + x*(-767602176 + x*(-116404992 + x*(43957760 + x*(23046144 + x*(2076672 + (-1118208 - 286720*x)*x))))))))))))/3.9239811072e12;
      case 4 : return (87479478289 + x*(179936422250 + x*(132096149304 + x*(18654204272 + x*(-30696937040 + x*(-18968194080 + x*(-2041197312 + x*(1987594752 + x*(782546688 + x*(-11123200 + x*(-68913152 + x*(-11341824 + x*(2609152 + 860160*x)))))))))))))/3.9239811072e12;
      case 5 : return (33558377993 + x*(26319768254 + x*(-14241645384 + x*(-21046097968 + x*(-4502288080 + x*(3045345696 + x*(1544293632 + x*(-63287808 + x*(-182018304 + x*(-23457280 + x*(11466752 + x*(3035136 + (-372736 - 172032*x)*x))))))))))))/3.567255552e11;
      case 6 : return (24422947927 + x*(-60787408850 + x*(-57400890168 + x*(9651302224 + x*(19079619280 + x*(1610969760 + x*(-2788859136 + x*(-564404736 + x*(236208384 + x*(73638400 + x*(-12548096 + x*(-5910528 + x*(372736 + 286720*x)))))))))))))/3.567255552e11;
      case 7 : return (-22161558721 + x*(-26858610182 + x*(18959018952 + x*(14548078576 + x*(-4278846640 + x*(-3233479968 + x*(507212544 + x*(429881856 + x*(-37930752 + x*(-39733760 + x*(1869824 + x*(2715648 + (-53248 - 122880*x)*x))))))))))))/1.189085184e11;
      case 8 : return (-22161558721 + x*(26858610182 + x*(18959018952 + x*(-14548078576 + x*(-4278846640 + x*(3233479968 + x*(507212544 + x*(-429881856 + x*(-37930752 + x*(39733760 + x*(1869824 + x*(-2715648 + x*(-53248 + 122880*x)))))))))))))/1.189085184e11;
      case 9 : return (24422947927 + x*(60787408850 + x*(-57400890168 + x*(-9651302224 + x*(19079619280 + x*(-1610969760 + x*(-2788859136 + x*(564404736 + x*(236208384 + x*(-73638400 + x*(-12548096 + x*(5910528 + (372736 - 286720*x)*x))))))))))))/3.567255552e11;
      case 10 : return (33558377993 + x*(-26319768254 + x*(-14241645384 + x*(21046097968 + x*(-4502288080 + x*(-3045345696 + x*(1544293632 + x*(63287808 + x*(-182018304 + x*(23457280 + x*(11466752 + x*(-3035136 + x*(-372736 + 172032*x)))))))))))))/3.567255552e11;
      case 11 : return (87479478289 + x*(-179936422250 + x*(132096149304 + x*(-18654204272 + x*(-30696937040 + x*(18968194080 + x*(-2041197312 + x*(-1987594752 + x*(782546688 + x*(11123200 + x*(-68913152 + x*(11341824 + (2609152 - 860160*x)*x))))))))))))/3.9239811072e12;
      case 12 : return (5965313739 + x*(-19997619122 + x*(29216011752 + x*(-23462660144 + x*(10089206160 + x*(-955345248 + x*(-1390346496 + x*(767602176 + x*(-116404992 + x*(-43957760 + x*(23046144 + x*(-2076672 + x*(-1118208 + 286720*x)))))))))))))/3.9239811072e12;
      case 13 : return (1195194077 + x*(-6126579914 + x*(14350094616 + x*(-20182358768 + x*(18742346480 + x*(-11769110496 + x*(4750217472 + x*(-896383488 + x*(-211850496 + x*(201710080 + x*(-54765568 + x*(-159744 + (4100096 - 860160*x)*x))))))))))))/5.10117543936e13;
      case 14 : return (1594307 + x*(-13817050 + x*(55264872 + x*(-135067504 + x*(224990480 + x*(-269549280 + x*(238427904 + x*(-156609024 + x*(74790144 + x*(-23795200 + x*(3221504 + x*(1118208 + x*(-692224 + 122880*x)))))))))))))/5.10117543936e13;
      case 15 : return (1 + x*(-26 + x*(312 + x*(-2288 + x*(11440 + x*(-41184 + x*(109824 + x*(-219648 + x*(329472 + x*(-366080 + x*(292864 + x*(-159744 + (53248 - 8192*x)*x))))))))))))/5.10117543936e13;
      default: return 0.0;
    }
    default: return 0.0;
  }
