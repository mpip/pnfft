...
## 3D:
test_files_2="$test_files check_trafo_2d check_trafo_transposed_2d"
...
test_files_8="$test_files check_trafo_vs_ndft check_trafo_vs_ndft_c2r"
test_files_8="$test_files check_trafo_grad_vs_ndft check_trafo_vs_ndft_transposed_2d"
test_files_8="$test_files check_trafo_hessian_vs_ndft"

test_files_8="$test_files check_adj check_adj_transposed"
test_files_8="$test_files check_adjvs_ndft check_adj_vs_ndft_c2r"
test_files_8="$test_files pnfft_test pnfft_test_adv"

# test_files_8="$test_files simple_test_c2r_c2c_compare_complex"
# test_files_8="$test_files simple_test_c2r_c2c_compare_grad"
# test_files_8="$test_files simple_test_c2r_c2c_compare_real"
# test_files_8="$test_files simple_test_c2r_c2c_compare_timer"
