...
%return_types = (
    ...
    "pnfft_nodes" => "type(C_PTR)",
    "pnfftf_nodes" => "type(C_PTR)",
    "pnfftl_nodes" => "type(C_PTR)",
    "pnfftq_nodes" => "type(C_PTR)",
    "void *" => "type(C_PTR)",
    "char *" => "type(C_PTR)",
    "double *" => "type(C_PTR)",
    "float *" => "type(C_PTR)",
...
%arg_types = (
    ...
    "pnfft_nodes" => "type(C_PTR), value",
    "pnfftf_nodes" => "type(C_PTR), value",
    "pnfftl_nodes" => "type(C_PTR), value",
    "pnfftq_nodes" => "type(C_PTR), value",
    "const pnfft_nodes" => "type(C_PTR), value",
    "const pnfftf_nodes" => "type(C_PTR), value",
    "const pnfftl_nodes" => "type(C_PTR), value",
    "const pnfftq_nodes" => "type(C_PTR), value",
